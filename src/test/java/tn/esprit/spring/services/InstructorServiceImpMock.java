...
public class InstructorServiceImpMock {
    ...
    public void testAddSkier() {
        ...
        instructor.setLastName("Fray");
        instructor.setFirstName("Mhamed");
    ...
    public void testRetrieveAllSkiers() {
        ...
        instructorList.add(new Instructor(2L,"Mhamed","Fray", LocalDate.of(2020, 6, 16),courses));
        instructorList.add(new Instructor(3L,"Lobna","Sakli", LocalDate.of(2020, 9, 19),courses));
